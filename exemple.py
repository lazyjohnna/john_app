#platform.openai.com/tokenizer      #token의 수를 볼 수 있음 token

# import sreamlit as st...      #streamlit 패키지 추가

#def askGpt(prompt):.,,,        #기능구현함수
...
#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
